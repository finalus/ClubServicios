<div class="box groups form">
    <div class="box-top">
        <h4 style="-moz-border-radius-topleft: 5px; -moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners"><?php printf(__('Admin Edit %s', true), __('Group', true)); ?></h4>
    </div>
